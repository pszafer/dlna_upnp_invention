...
urlpatterns = patterns('',
 ...
 #  url('', RedirectView.as_view(url='/dlnaupnpmanagment/status'), name='some_redirect'),
    ...
    url(r'^dlnaupnpmanagment/changeLanguage', 'dlnaupnpmanagment.dlnaupnpmanage.views.views_settings.changeLanguage'),
    ...
    url(r'^dlnaupnpmanagment/getServerName', 'dlnaupnpmanagment.dlnaupnpmanage.views.views_status.getServerName'),
    ...
    url(r'^dlnaupnpmanagment/help', 'dlnaupnpmanagment.dlnaupnpmanage.views.views_help.help'),
